...
$totalReceitasMasculinas = 0;

foreach($transacoes as $transacao) {
  if($transacao ["genero"] == "masculino" && $transacao["tipoDeTransacao"] == "Despesa") {
    $totalReceitasMasculinas = $transacao["valor"];
  }
}

echo "Valor total de Receitas: $totalReceitasMasculinas";
?>
